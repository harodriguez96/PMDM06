...
class FilesystemWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  constructor() {
    ...
    this.downloadFile = /*#__PURE__*/function () {
      var _ref = (0,C_Users_haize_Desktop_pmdm_workspace_pmdm_tev6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (options) {
        var _a, _b;
  ...
  readFile(options) {
    ...
    return (0,C_Users_haize_Desktop_pmdm_workspace_pmdm_tev6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const path = _this6.getPath(options.directory, options.path); // const encoding = options.encoding;
  ...
  _copy(options, doRename = false) {
    ...
    return (0,C_Users_haize_Desktop_pmdm_workspace_pmdm_tev6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const toPath = _this17.getPath(toDirectory, to); // Test that the "to" and "from" locations are different
      ...
      const updateTime = /*#__PURE__*/function () {
        var _ref3 = (0,C_Users_haize_Desktop_pmdm_workspace_pmdm_tev6_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (path, ctime, mtime) {
